...
- React-router
  ...
  - 처음에는 v5로 작성했으나 이후 v6로 업데이트를 진행했습니다.
- Emotion.js
...
- 이번 프로젝트를 통해 다음의 경험을 얻을 수 있었습니다.
    1. 리액트 등의 라이브러리에 대한 기본적인 사용 경험을 기를 수 있었습니다.
        - 이전에는 강의를 통해 단순히 지식만을 얻었다면, 처음으로 무언가를 만들어보며 이론과 실제가 얼마나 다른지에 대한 경험을 쌓았습니다.
    2. 기능 구현 계획에 관한 경험과 문제 해결 방법에 대한 경험을 쌓았습니다.
        - 이전까진 강의를 통해 언어를 학습하여 문제 해결을 위해 적극적으로 탐색하는 경험이 부족했습니다.
        - 실제로 앱을 계획해보고, 구현하는 과정에서 마주친 문제를 고민하는 과정을 통해 이러한 부족했던 부분을 보완할 수 있었습니다.
